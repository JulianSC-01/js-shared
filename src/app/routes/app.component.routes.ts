...
export const appComponentRoutes: Routes = [
  ...
  { path: 'formReactive',
    ...
    children: [
      { path: '',
        redirectTo: 'errorHeader',
        pathMatch: 'full' },
      { path: 'errorHeader',
        component: AppFormErrorHeaderComponent },
      { path: 'errorFeedback',
        component: AppFormErrorFeedbackComponent },
      { path: 'formLabel',
        component: AppFormLabelComponent },
      { path: 'formInputNumber',
        component: AppFormInputNumberComponent },
      { path: 'formInputSelect',
        component: AppFormInputSelectComponent },
      { path: 'formInputText',
        component: AppFormInputTextComponent }
    ]
  },
  { path: 'formTemplate',
